...
switch sensor
    case 'sbe41cp'
        ...
        PARAMETERS(1).PREDEPLOYMENT_CALIB_DATE = '2021-03-31'; % use yyyy-mm-dd
        ...
        PARAMETERS(2).PREDEPLOYMENT_CALIB_DATE = '2021-03-31'; % use yyyy-mm-dd
        ...
        PARAMETERS(3).PREDEPLOYMENT_CALIB_DATE = '2021-03-31'; % use yyyy-mm-dd
    ...
    case 'rbrargo3'
        ...
        PARAMETERS(1).PREDEPLOYMENT_CALIB_DATE = '2020-12-03'; % use yyyy-mm-dd
        ...
        PARAMETERS(2).PREDEPLOYMENT_CALIB_DATE = '2020-12-02'; % use yyyy-mm-dd
        ...
        PARAMETERS(3).PREDEPLOYMENT_CALIB_DATE = '2020-12-09'; % use yyyy-mm-dd
        ...
        PARAMETERS(4).PREDEPLOYMENT_CALIB_DATE = '2020-12-02'; % use yyyy-mm-dd
    ...
    case 'aanderaaoptode'
        ...
        PARAMETERS(1).PREDEPLOYMENT_CALIB_DATE = 'unknown'; % use yyyy-mm-dd
        ...
        PARAMETERS(2).PREDEPLOYMENT_CALIB_DATE = 'unknown'; % use yyyy-mm-dd
        ...
        PARAMETERS(3).PREDEPLOYMENT_CALIB_DATE = 'unknown'; % use yyyy-mm-dd
        ...
        PARAMETERS(4).PREDEPLOYMENT_CALIB_DATE = 'unknown'; % use yyyy-mm-dd
        ...
        PARAMETERS(5).PREDEPLOYMENT_CALIB_DATE = 'unknown'; % use yyyy-mm-dd
...
allout.info.contents = 'json file to describe a sensor for Argo. v0.1 draft';
allout.info.sensor_described = sensor_described;
